...
/**
 * Unit tests for special CVM instructions: Load, Get, Put, and Invoke.
 */
class SpecialInstructionTest {
    ...
    @Test
    void loadImmediate() {
        new Load((byte) 0, 42L, ctx).invoke();
    ...
    void invokeSimpleFunction() {
        ...
        foo.addInstruction(new Load((byte) 0, 7L, ctx));
        ctx.addFun(foo);
